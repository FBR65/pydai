...
def duckduckgo_search(query: str, num_results: int = 10) -> DuckDuckGoSearchResults:
    """
    Performs a search on DuckDuckGo using the duckduckgo_search library and returns
    the results as a DuckDuckGoSearchResults object.
...
if __name__ == "__main__":
    ...
    search_results: DuckDuckGoSearchResults = duckduckgo_search(search_query)
